...
public class MainController implements Initializable {
    ...
    private static String curCloudPath = ClientProperties.cloudDirectory;
    private static String curLocalPath = ClientProperties.localDirectory;
    ...
    private void createCommandResultHandler() {
        new Thread(() -> {
            byte[] buffer = new byte[Integer.parseInt(ClientProperties.bufferLength)];
            while (true) {
